...
const NewPost: React.FC = () => {
    ...
    const provinces = [
        { name: 'กรุงเทพมหานคร', districts: ['เขตพระนคร', 'เขตดุสิต', 'เขตบางรัก'] },
        { name: 'เชียงใหม่', districts: ['อำเภอเมือง', 'อำเภอสันกำแพง', 'อำเภอแม่ริม'] },
        { name: 'ภูเก็ต', districts: ['อำเภอเมือง', 'อำเภอกะทู้', 'อำเภอถลาง'] },
    ];

    const subDistricts: { [key: string]: string[] } = {
        'เขตพระนคร': ['ตำบลสำราญราษฎร์', 'ตำบลบวรนิเวศ', 'ตำบลวัดสามพระยา'],
        'อำเภอเมือง': ['ตำบลในเมือง', 'ตำบลฟ้าฮ่าม', 'ตำบลป่าแดด'],
        'อำเภอกะทู้': ['ตำบลป่าตอง', 'ตำบลกมลา', 'ตำบลกะทู้'],
    };
...
{/* Cat Info Textarea and Submit Button */}
